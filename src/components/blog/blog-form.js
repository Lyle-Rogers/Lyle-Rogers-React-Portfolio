...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://lylerogers.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        }
    ...
    deleteImage(imageType) {
        axios
            .delete(`https://api.devcamp.space/portfolio/delete-portfolio-blog-image/${this.state.id}?image_type=${imageType}`, { withCredentials: true }
                ).then(response => {
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://lylerogers.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction: "patch"
            });
        }
    }
