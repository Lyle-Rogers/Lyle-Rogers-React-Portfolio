...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://lylerogers.devcamp.space/portfolio/portfolio_items",
            apiAction: "post"
        }
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://lylerogers.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
        ...
        return (
            <form onSubmit={this.handleSubmit} className="portfolio-form-wrapper">
                <div className="two-column">
                    <input 
                        type="text" 
                        name="name" placeholder="Portfolio Item Name" 
